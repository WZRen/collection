package com.cyril.collection.widget;
...
public class IncreaseNumberView extends TextView {
    ...
    public IncreaseNumberView(Context context) {
        this(context, null);
    }

    public IncreaseNumberView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IncreaseNumberView(Context context, AttributeSet attrs, int defStyleAttr) {
